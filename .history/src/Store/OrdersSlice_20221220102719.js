...
export const checkoutStatusFunc = (state)=> state.orderedFood.checkoutStatus;
export const { getOrders, deleteOrder, multipleItemsHandler, setCheckoutStatusStatic, setCheckoutStatusWithUrl } =
  ordersSlice.actions;
