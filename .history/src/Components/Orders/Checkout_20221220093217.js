...
export default function () {
  ...
  return (
    <div>
      <li>Items</li>
      <p>Choose Location</p>
      {}//Some error msg that you did not clicked a button either useCurrentlocation or other location
      <button onClick={currentLocationClkHnadler}>
        Use Current Location
      </button>
      <Link><button onClick={otherLocationClkHandler}>Other Location...</button></Link>
      <div>Total Price</div>
