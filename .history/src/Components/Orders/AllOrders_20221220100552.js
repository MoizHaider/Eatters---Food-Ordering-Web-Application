...
import { orderBtnStatus, orderedItems, setCheckoutStatusStatic } from "../../Store/OrdersSlice";
...
export default function AllOrders() {
  ...
  return (
    <div>
      ...
      <Link to = {"checkout"}><button onClick={onOrderClickHandler} disabled={orderbtnStatus}>
        Order Now
      </button></Link>
    </div>
  );
