...
export default function MapComponent() {
  ...
  const checkoutMapStatus= (window.location.href.includes("/checkoutMap") && checkoutStatus===true ) ;
  console.log(`URL ${window.location.href === "/checkoutMap"}`)
  ...
  return (
    <div>
      ...
      {checkoutMapStatus && <input placeholder="Search a Location"/>}
