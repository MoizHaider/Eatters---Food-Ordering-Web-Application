    ...
    return (
        <div>
            ...
            <form onSubmit={onSubmitHandler}>
                ...
                <input type="text" ref = {firstNameRef} {firstNameRef./> 
                <label>Email</label>
                <input type="email"  ref = {emailRef} = {e/>
                <label>Possword</label>
                <input type="password" ref={passwordRef} = {pass />
                <label>Confirm Password</label>
                <input type="password" ref = {cnfrmPasswordRef} = {cnfrmPass/>
