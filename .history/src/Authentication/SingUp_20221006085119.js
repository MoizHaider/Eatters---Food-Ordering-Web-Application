    ...
    return (
        <div>
            ...
            <form onSubmit={onSubmitHandler}>
                ...
                <input type="text" ref = {firstNameRef} {firstNameRef.current./> 
                <label>Email</label>
                <input type="email"  ref = {emailRef} = {emailRef.current./>
                <label>Possword</label>
                <input type="password" ref={passwordRef} = {passwordRef.current. />
                <label>Confirm Password</label>
                <input type="password" ref = {cnfrmPasswordRef} = {cnfrmPasswordRef.current./>
